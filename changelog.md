...
### Added
- A [Ntfy](https://docs.ntfy.sh/install/#docker) container.
- A [Wireguard](https://github.com/linuxserver/docker-wireguard) VPN container.
- A [script to check disk usage](./scripts/check_disk_space.sh) with configurable bounds.

### Changed
- Updated scripts to publish status to self-hosted Ntfy server.

## [0.14.0] - 2026/06/21
### Added
- An LLM to the server with Ollama and Open WebUI.
...
## [0.12.0] - 2026/01/24
### Added
- [Immich](https://immich.app/), a self-hosted image and video storage solution.
